...
const COA: React.FC = () => {
  ...
  if (settingLoading || loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-pink-50 to-cyan-50 flex items-center justify-center">
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-pink-50 to-cyan-50 flex items-center justify-center">
        <div className="text-center p-8">
          ...
          <a href="/" className="px-6 py-2 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-colors">
            Return Home
          </a>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-pink-50 to-cyan-50">
      {/* Hero Section - Mobile Optimized */}
      <div className="relative overflow-hidden bg-gradient-to-r from-pink-100 to-pink-100 py-6 md:py-12">
        <div className="absolute top-0 left-0 w-48 h-48 md:w-64 md:h-64 bg-pink-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30"></div>
        ...
        <div className="relative container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-1.5 md:gap-2 bg-white/90 backdrop-blur-md px-3 py-1.5 md:px-6 md:py-3 rounded-full shadow-cute mb-3 md:mb-6 border-2 border-pink-200">
              <Shield className="w-3.5 h-3.5 md:w-5 md:h-5 text-pink-500" />
            ...
            <p className="text-sm md:text-lg text-gray-600 mb-4 md:mb-6 px-4">
              Tested by <strong className="text-pink-600">Janoshik + Chromate</strong>
            </p>

            <div className="flex flex-wrap justify-center gap-2 md:gap-4 text-xs md:text-sm px-2">
              <div className="flex items-center gap-1.5 md:gap-2 bg-white/80 backdrop-blur-sm px-2.5 py-1.5 md:px-4 md:py-2 rounded-full shadow-md border border-pink-200">
                <CheckCircle className="w-3.5 h-3.5 md:w-5 md:h-5 text-green-500" />
                <span className="font-medium text-gray-700">99%+ Purity</span>
              </div>
              <div className="flex items-center gap-1.5 md:gap-2 bg-white/80 backdrop-blur-sm px-2.5 py-1.5 md:px-4 md:py-2 rounded-full shadow-md border border-pink-200">
                <Award className="w-3.5 h-3.5 md:w-5 md:h-5 text-pink-500" />
      ...
      <div className="container mx-auto px-3 md:px-4 py-6 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-6xl mx-auto">
          {coaReports.length === 0 ? (
            ...
            coaReports.map((report) => (
              <div
                key={report.id}
                className="bg-white rounded-2xl md:rounded-3xl shadow-cute hover:shadow-glow transition-all duration-300 overflow-hidden border-2 border-pink-100 hover:border-pink-200 transform hover:-translate-y-1 md:hover:-translate-y-2"
              >
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 bg-pink-600/0 group-hover:bg-pink-600/10 transition-all duration-300 flex items-center justify-center">
                    <div className="opacity-0 group-hover:opacity-100 transition-opacity bg-white/95 backdrop-blur-sm px-3 py-1.5 md:px-4 md:py-2 rounded-xl md:rounded-2xl shadow-lg">
                      <p className="text-xs md:text-sm font-bold text-pink-600 flex items-center gap-1.5 md:gap-2">
                ...
                <div className="p-4 md:p-6">
                  ...
                  <div className="space-y-2 md:space-y-3">
                    ...
                    <button
                      onClick={() => setSelectedImage(report.image_url)}
                      className="w-full flex items-center justify-center gap-1.5 md:gap-2 bg-white text-pink-600 border-2 border-pink-400 hover:border-pink-500 hover:bg-pink-50 px-3 py-2 md:px-4 md:py-3 rounded-xl md:rounded-2xl text-sm md:text-base font-medium transition-all duration-300"
                    >
        ...
        <div className="mt-6 md:mt-12 max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-pink-50 to-pink-50 rounded-2xl md:rounded-3xl p-4 md:p-6 lg:p-8 border-2 border-pink-200 shadow-cute">
            <div className="flex flex-col md:flex-row items-start gap-3 md:gap-4">
              <div className="flex-shrink-0">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-pink-400 to-pink-500 rounded-xl md:rounded-2xl flex items-center justify-center">
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 md:gap-2 text-sm md:text-base text-pink-600 hover:text-pink-700 font-medium"
                  >
                    <span>Janoshik</span>
