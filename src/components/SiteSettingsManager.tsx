...
const SiteSettingsManager: React.FC = () => {
  ...
  const handleResetDefaults = () => {
    if (confirm('Are you sure you want to reset the homepage content to defaults?')) {
      setFormData(prev => ({
        ...prev,
        hero_badge_text: 'Precision. Purity. Performance.',
        ...
        hero_description: 'LUXXBIO LABS provides research-grade peptides engineered for precision, purity, and consistency.',
      }));
    }
  };
            ...
            <div className="shrink-0">
              ...
              <div className="flex items-center gap-4">
                <div className="w-20 h-20 rounded-full overflow-hidden bg-gray-100 border border-gray-200">
                  <img src={logoPreview || '/luxxbio-logo.png'} alt="Logo" className="w-full h-full object-cover" />
                </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. Precision. Purity. Performance."
            />
          </div>
