...
const HomeSections: React.FC<HomeSectionsProps> = ({ onJoinCommunity, onLearnMore }) => {
  return (
    <>
      ...
      <section className="relative -mt-12 md:-mt-20 z-20 px-5 md:px-8">
        <div className="container mx-auto">
          <div
            className="rounded-3xl bg-white px-6 md:px-10 py-8 md:py-10"
            style={{
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 divide-y sm:divide-y-0 sm:divide-x divide-slate-100">
              {FEATURES.map(({ icon: Icon, title, desc }, i) => (
                <div
                  key={title}
                  className={`flex gap-4 pt-6 sm:pt-0 ${i === 0 ? 'pt-0' : ''} sm:px-4 first:sm:pl-0 last:sm:pr-0`}
                >
                  <div
                  ...
                  <div>
                    <h3 className="font-sans font-semibold text-sm mb-1.5" style={{ color: '#0A1A2E' }}>
                      {title}
                    </h3>
                    <p className="font-sans text-xs leading-relaxed" style={{ color: '#475A85' }}>
                      {desc}
                    </p>
                  </div>
                </div>
      ...
      {/* ── Mission section ── */}
      <section className="py-20 md:py-28" style={{ background: '#F5F7FB' }}>
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            <div>
              ...
              <h2
                ...
                style={{ fontSize: 'clamp(2rem, 4vw, 3rem)', color: '#0A1A2E', lineHeight: 1.1 }}
              >
                Empowering your{' '}
                <span
                  style={{
              ...
              <p className="font-sans text-base leading-7 mb-8" style={{ color: '#475A85' }}>
      ...
      {/* ── Glow Up CTA banner ── */}
      <section className="py-12 md:py-16 px-5 md:px-8" style={{ background: '#F5F7FB' }}>
        <div className="container mx-auto">
          <div
            className="relative overflow-hidden rounded-3xl px-8 md:px-12 py-10 md:py-12"
            style={{
              background:
          ...
          >
            ...
            <div className="relative z-10 grid md:grid-cols-[1fr_1fr_auto] items-center gap-6 md:gap-10">
              <h3
              ...
              <p className="font-sans text-sm leading-6" style={{ color: '#C2CCDF' }}>
                Join our community and get access to exclusive updates, tools, and support to help you stay consistent.
              </p>
              <button
                onClick={onJoinCommunity}
                className="inline-flex items-center justify-center gap-2 rounded-full px-7 py-4 font-sans text-sm font-semibold text-white transition-all duration-200 hover:-translate-y-0.5 whitespace-nowrap"
                style={{
