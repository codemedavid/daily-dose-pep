  ...
  const fetchSiteSettings = async () => {
    try {
      ...
      const settings: SiteSettings = {
        site_name: settingsData.find(s => s.id === 'site_name')?.value || 'Daily Dose Pep',
        site_logo: settingsData.find(s => s.id === 'site_logo')?.value || '/ddp-logo.png',
        ...
        hero_description: settingsData.find(s => s.id === 'hero_description')?.value || 'Daily Dose Pep provides research-grade peptides engineered for precision, purity, and consistency.',
